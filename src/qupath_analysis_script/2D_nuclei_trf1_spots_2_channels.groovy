...
//Spot detection of telomeres using QuPath subcellular detection on Channel 2. Adapt it to your specific channel and fine-tune your particular detection settings
runPlugin('qupath.imagej.detect.cells.SubcellularDetection', '{"detection[Channel 1]":-1.0,"detection[Channel 2]":6000.0,"doSmoothing":false,"splitByIntensity":true,"splitByShape":true,"spotSizeMicrons":0.2,"minSpotSizeMicrons":0.06,"maxSpotSizeMicrons":0.5,"includeClusters":true}')
selectDetections();
//Calculate Max and Min intensities for all cells and spots
runPlugin('qupath.lib.algorithms.IntensityFeaturesPlugin', '{"pixelSizeMicrons":0.0902,"region":"ROI","tileSizeMicrons":25.0,"channel1":false,"channel2":true,"doMean":false,"doStdDev":false,"doMinMax":true,"doMedian":false,"doHaralick":false,"haralickMin":NaN,"haralickMax":NaN,"haralickDistance":1,"haralickBins":32}')
...
setCellIntensityClassifications("Subcellular: Channel 2: Num spots estimated", 5)
